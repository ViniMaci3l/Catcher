...
class ChooseEnemyScene extends Phaser.Scene {
    ...
    preload() {
        // Ajuste os caminhos das imagens para incluir o nome do repositório
        this.load.image('presa1', '/meu-jogo/assets/presa1.png');
        this.load.image('presa2', '/meu-jogo/assets/presa2.png');
        this.load.image('presa3', '/meu-jogo/assets/presa3.png');
        this.load.image('background1', '/meu-jogo/assets/background1.png');
    }
...
class TutorialScene extends Phaser.Scene {
    ...
    preload() {
        // Ajuste o caminho da imagem de fundo
        this.load.image('background2', '/meu-jogo/assets/background2.png');
    }
...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('background3', '/meu-jogo/assets/background2.png');
        this.load.image('platform', '/meu-jogo/assets/platform.png');
    }
...
class GameOverScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image('background4', '/meu-jogo/assets/background2.png');
        this.load.image('botão1', '/meu-jogo/assets/botão1.png');
    }
...
class WinScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image('background5', '/meu-jogo/assets/background2.png');
        this.load.image('botão1', '/meu-jogo/assets/botão1.png');
    }
